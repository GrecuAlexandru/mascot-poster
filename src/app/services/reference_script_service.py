...
class ReferenceScriptService:
    ...
    async def generate(
        ...
        user = (
            ...
            "Adaugă separat closing cu id exact closing, 6-28 de cuvinte, una sau două "
            "propoziții complete care dau verdictul sau concluzia, fără fapte noi, și "
            "pause_after_ms 500 sau 750. "
